...
- 目前 source candidate：**v0.3.10**（public teacher-test prerelease；刻意未簽章，非 Latest）
...
- `v0.3.7` annotated tag object 是 `f7efc67da97f3f4fc77bfc89625f8cb902d53cf6`，product commit 是
  ...
  product/source commit 是 `fd43bdad500418570d8dc3f7f0bdbb7794c1ed46`；後續 main 上的文件合併可能讓 branch 前進，
...
- 學習歷程與外部實測回填底稿見
  [`teacher-pilot-v0.3.10-draft.md`](docs/learning-history/teacher-pilot-v0.3.10-draft.md)；目前明確標記為
...
- v0.3.7 與 v0.3.8 保留為歷史 unsigned prerelease，不覆寫既有 tag、Release 或 asset；v0.3.9 與 v0.3.10 使用新 tag、新 commit 與新 SHA。

v0.3.10 teacher candidate 已按上述例外實際發布：Release run `31108379560`、tag/source 綁定與 installer SHA-256 均已獨立核對；它仍不具可信簽章、不進 Latest，也沒有真人老師或第二台電腦結果。v0.3.9 與 v0.3.8 的公開候選與證據仍完整保留。
