...
- 目前 source candidate：**v0.3.11**（public teacher-test prerelease；刻意未簽章，非 Latest）
...
- v0.3.10 teacher candidate Release：<https://github.com/enzohuang98-crypto/Reckoning/releases/tag/v0.3.10>（2026-08-06 發布、非 draft、prerelease、刻意未簽章；沒有升為 Latest）
- v0.3.11 teacher candidate Release：<https://github.com/enzohuang98-crypto/Reckoning/releases/tag/v0.3.11>（2026-08-07 發布、非 draft、prerelease、刻意未簽章；沒有升為 Latest）
- `v0.3.7` annotated tag object 是 `f7efc67da97f3f4fc77bfc89625f8cb902d53cf6`，product commit 是
  ...
  `81bee70dd1eaf53014fa8ffd736195f5eae98855`。v0.3.9 Release evidence capture 的
  product/source commit 是 `5514b3ecfc63481a3942a277605d9114f1b54308`；v0.3.10 Release evidence capture 的
  product/source commit 是 `fd43bdad500418570d8dc3f7f0bdbb7794c1ed46`；v0.3.11 Release evidence capture 的
  product/source commit 是 `c45c92585d35bee62a1186dd9816fb12ae2e0284`；後續 main 上的文件合併可能讓 branch 前進，
  不可把歷史 snapshot、Release product commit 與後續 main 混為同一版。
...
- v0.3.10 teacher-candidate Release run `31108379560` 的 build、完整測試、audit、unsigned install/uninstall
  smoke 與 Server 2022/2025 proxy 全部成功；安裝檔大小 `164630893` bytes、SHA-256 為
  `6facf8bca3a202fe4d668da3235b0b90b006d96f0cfc6ecd04c61ac0113c0aa7`。它補上 teacher-test active-run
  畫面的完整版本／來源／安裝檔／runtime 身分與 7 維度 rubric 合約；Win10/Win11 client evidence 與
  promotion 依 mode 明確 skipped，完整紀錄見
  [`release-v0.3.10-evidence.md`](docs/operations/release-v0.3.10-evidence.md)。
- v0.3.11 teacher-candidate Release run `31134511847` 的 build、完整測試、audit、unsigned install/uninstall
  smoke 與 Server 2022/2025 proxy 全部成功；安裝檔大小 `164630863` bytes、SHA-256 為
  `31d89f8c69dbaec1aec2be2205108b54d4bec243dc9e2eb7b8ccfb412c762824`。它修復新出現的 `js-yaml` high
  advisory（4.3.0 → 4.3.1），並保留 teacher-test identity／rubric 修正；Win10/Win11 client evidence 與
  promotion 依 mode 明確 skipped，完整紀錄見
  [`release-v0.3.11-evidence.md`](docs/operations/release-v0.3.11-evidence.md)。
...
- 學習歷程與外部實測回填底稿見
  [`teacher-pilot-v0.3.11-draft.md`](docs/learning-history/teacher-pilot-v0.3.11-draft.md)；目前明確標記為
...
| v0.3.10 | 2026-08-06 | teacher-test candidate identity／rubric revision：Settings 顯示完整 run identity，外部 protocol 對齊 7 個 1–5 維度與 3 個獨立 gate；三個老師確認案例與雙機真人驗收仍 pending |
| v0.3.11 | 2026-08-07 | 修復新出現的 `js-yaml` high advisory（4.3.0 → 4.3.1），以新 tag／Release 保持 candidate 身分；三個老師確認案例與雙機真人驗收仍 pending |
...
- v0.3.7 與 v0.3.8 保留為歷史 unsigned prerelease，不覆寫既有 tag、Release 或 asset；v0.3.9、v0.3.10 與 v0.3.11 使用新 tag、新 commit 與新 SHA。

v0.3.11 teacher candidate 已按上述例外實際發布：Release run `31134511847`、tag/source 綁定與 installer SHA-256 均已獨立核對，且目前 runtime／build dependency audit 已重新通過；它仍不具可信簽章、不進 Latest，也沒有真人老師或第二台電腦結果。v0.3.10、v0.3.9 與 v0.3.8 的公開候選與證據仍完整保留。
