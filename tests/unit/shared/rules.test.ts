 ...
 *
 * 執行：npx tsx --tsconfig tsconfig.node.json tests/unit/shared/rules.test.ts
 *
...
import {
  ...
  legalMoveCheck,
  parseUciMove
} from '../../../src/shared/logic/board/moves'
...
import {
  ...
  redoBoard,
  undoBoard
} from '../../../src/shared/logic/board/BoardTimeline'
import {
  formatChineseMove,
  formatChineseVariation
} from '../../../src/shared/logic/board/ChineseNotation'
